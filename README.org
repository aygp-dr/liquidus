...
| v1.1    | liquidus-002 (Python) feedback       | pending        | pending    |
| v1.2    | liquidus-003 (Go) feedback           | pending        | pending    |
| v1.3    | liquidus-004 (TypeScript) feedback   | pending        | pending    |
| v1.4    | liquidus-005 (MCP) feedback          | pending        | pending    |
